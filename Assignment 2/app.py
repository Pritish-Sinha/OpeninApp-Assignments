...
hashtag_output = gr.outputs.Textbox(label="Trending Hashtags")

interface = gr.Interface(fn=hashtag_generator, inputs=image_input, outputs=hashtag_output, title="Trending Hashtag Generator")
interface.launch()
